...
| Menu | Akses | Fungsi | Aturan | Efek sistem | Koreksi |
| --- | --- | --- | --- | --- | --- |
| Chart of Accounts | Owner, Finance | Daftar akun akuntansi untuk jurnal dan laporan. | Akun standar tidak perlu diubah. Tambah akun hanya jika kebutuhan laporan jelas. | Menentukan klasifikasi Neraca dan Laba Rugi. | Jika mapping akun salah, koreksi mapping/transaksi sebelum tutup buku atau buat jurnal penyesuaian. |
| Jurnal Penyesuaian | Owner, Finance | Buat/edit/hapus jurnal manual. | Debit harus sama kredit. Hanya jurnal manual yang bisa diedit langsung. Jurnal otomatis dikoreksi lewat modul asal/reversal. | Langsung memengaruhi laporan, tetapi tidak otomatis mengubah stok/invoice/hutang/bank operasional. | Edit/hapus jurnal manual selama periode belum dikunci. Untuk jurnal otomatis, koreksi transaksi sumber. |
